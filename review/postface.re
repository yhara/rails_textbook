 ...
 ** @<href>{http://guides.rubyonrails.org/,http://guides.rubyonrails.org/}
...
なにより、自分で作りたいアプリを作ってみるのが一番勉強になります。作っている上で、もしもつまづき、インターネットで検索しても分からないことがあったときには、近くのRubyコミュニティの集まりへぜひ足を運んでみてください。新しいRubyist（あなたのことです！）を温かく迎えてくれるはずです。Rubyコミュニティは「都市名.rb」という名前で活動していることが多いです。また、@<href>{http://rubykaigi.org/,RubyKaigi}や@<href>{http://regional.rubykaigi.org/,地方Ruby会議}と呼ばれるカンファレンスも定期的に開催されています。
